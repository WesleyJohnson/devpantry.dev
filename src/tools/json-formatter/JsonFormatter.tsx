...
function formatJson(input: string, mode: Mode): { output: string; error: string | null } {
...
export default function JsonFormatter() {
  ...
  const { output, error } = useMemo(() => formatJson(input, mode), [input, mode])
